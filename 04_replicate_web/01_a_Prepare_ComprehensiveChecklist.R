# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare comprehensive checklist
...
# Description: "Prepare comprehensive checklist" prepares a SQL query to create a checklist for upload into a web available MySQL database.
# ---------------------------------------------------------------------------
...
sql_checklist = paste(drive,
                      root_folder,
                      'GitHub/wildlife-taxonomy-database/04_replicate_web/01_b_Insert_ComprehensiveChecklist.sql',sep = "/")

# Identify taxonomy tables
checklist_file = paste(data_folder,
                      'Query_ComprehensiveChecklist.csv',
                      sep='/')
...
statement = c(
  ...
  '-- Description: "Create comprehensive checklist" pushes data from a comprehensive checklist export into the web database server.',
  '-- ---------------------------------------------------------------------------',
  '',
  '-- Drop comprehensive checklist and create new version',
  'DROP TABLE IF EXISTS `comprehensive_checklist`;',
  'CREATE TABLE `comprehensive_checklist` (',
  ...
  '',
  '-- Insert data into comprehensive checklist',
  'INSERT INTO `comprehensive_checklist` (`name_id`, `name`, `status`, `name_accepted`, `family`, `order`, `class`, `source`, `level`) VALUES'
)
