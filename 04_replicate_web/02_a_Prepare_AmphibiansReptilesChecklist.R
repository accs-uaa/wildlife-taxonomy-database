# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Prepare amphibians & reptiles checklist
...
# Description: "Prepare amphibians & reptiles checklist" prepares a SQL query to create a checklist for upload into a web available MySQL database.
# ---------------------------------------------------------------------------
...
sql_checklist = paste(drive,
                      root_folder,
                      'GitHub/wildlife-taxonomy-database/04_replicate_web/02_b_Insert_AmphibiansReptilesChecklist.sql',sep = "/")

# Identify taxonomy tables
checklist_file = paste(data_folder,
                      'Query_AmphibiansReptilesChecklist.csv',
                      sep='/')
