...
# Description: "Prepare mammals checklist" prepares a SQL query to create a checklist for upload into a web available MySQL database.
# ---------------------------------------------------------------------------
...
sql_checklist = paste(drive,
                      root_folder,
                      'GitHub/wildlife-taxonomy-database/04_replicate_web/04_b_Insert_MammalsChecklist.sql',sep = "/")

# Identify taxonomy tables
checklist_file = paste(data_folder,
                      'Query_MammalsChecklist.csv',
                      sep='/')
...
statement = c(
  ...
  '-- Description: "Create mammals checklist" pushes data from a mammals checklist export into the web database server.',
  '-- ---------------------------------------------------------------------------',
  '',
  '-- Drop mammals checklist and create new version',
  'DROP TABLE IF EXISTS `mammals_checklist`;',
  'CREATE TABLE `mammals_checklist` (',
  ...
  '',
  '-- Insert data into mammals checklist',
  'INSERT INTO `mammals_checklist` (`name_id`, `name`, `status`, `name_accepted`, `family`, `order`, `class`, `source`, `level`) VALUES'
)
