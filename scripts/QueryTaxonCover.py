# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Query Vegetation Cover by Taxon
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Created on: 2018-07-30
# Usage: Must be executed as an ArcPy Script.
# Description: This tool queries the MySQL Alaska Vegetation Plots Database for cover by a taxon. Cover values are aggregated so that multiple values at a single site for a single date are summed.
# ---------------------------------------------------------------------------
...
FROM abundance
 ...
 JOIN (
	...
	WHERE speciesAccepted.nameAccepted LIKE %s
...
arcpy.CalculateField_management(output_feature, "nameAccepted", taxon, "PYTHON3")
