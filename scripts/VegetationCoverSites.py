...
if type == "vascular":
    coverSites_query = coverSites_query + (""" WHERE vascularScope1.scopeType = 'exhaustive'""")
elif type == "non-vascular":
    coverSites_query = coverSites_query + (""" WHERE nonvascularScope1.scopeType IN ('exhaustive', 'high cover species')""")
elif type == "lichen":
    coverSites_query = coverSites_query + (""" WHERE lichenScope1.scopeType IN ('exhaustive', 'high cover species')""")
else:
